...
FlowRouter.route('/', {
    action: function() {
        FlowRouter.go('/nomadixdashboard');
    }
});
...
FlowRouter.route('/quvidi', {
    action: function() {
        BlazeLayout.render("mainLayout", {content: "Quvidi"});
    }
});


FlowRouter.route('/nomadixdashboard', {
    action: function() {
        BlazeLayout.render("mainLayout", {content: "nomadixdashboard"});
    }
});
